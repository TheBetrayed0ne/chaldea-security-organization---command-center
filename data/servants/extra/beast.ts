...
export const BEAST_SERVANTS: Servant[] = [
  { 
    ...
    image: 'https://static.wikia.nocookie.net/typemoon/images/4/4d/BeastSpaceEreshkigalStage1.png',
  ...
  { 
    ...
    image: 'https://static.wikia.nocookie.net/fategrandorder/images/3/3a/S377_Stage1.webp',
  ...
  { 
    ...
    image: 'https://static.wikia.nocookie.net/fategrandorder/images/7/76/S444_Stage3.webp',
